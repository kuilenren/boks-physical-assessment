...
export const NATIONAL_2014_STANDARD_NAME = "国家学生体质健康标准（2014年修订）";
...
const run50mTables: BandTablesByGrade = {
  "1": table(
    "lower_is_better",
    [
      10.2, 10.3, 10.4, 10.5, 10.6, 10.8, 11.0, 11.2, 11.4, 11.6, 11.8, 12.0,
      12.2, 12.4, 12.6, 12.8, 13.0, 13.2, 13.4, 13.6,
    ],
    [
      11.0, 11.1, 11.2, 11.5, 11.8, 12.0, 12.2, 12.4, 12.6, 12.8, 13.0, 13.2,
  ...
  "2": table(
    "lower_is_better",
    [
      9.6, 9.7, 9.8, 9.9, 10.0, 10.2, 10.4, 10.6, 10.8, 11.0, 11.2, 11.4, 11.6,
      11.8, 12.0, 12.2, 12.4, 12.6, 12.8, 13.0,
    ],
    [
      10.0, 10.1, 10.2, 10.5, 10.8, 11.0, 11.2, 11.4, 11.6, 11.8, 12.0, 12.2,
  ...
  "3": table(
    "lower_is_better",
    [
      9.1, 9.2, 9.3, 9.4, 9.5, 9.7, 9.9, 10.1, 10.3, 10.5, 10.7, 10.9, 11.1,
      11.3, 11.5, 11.7, 11.9, 12.1, 12.3, 12.5,
    ],
    [
      9.2, 9.3, 9.4, 9.7, 10.0, 10.2, 10.4, 10.6, 10.8, 11.0, 11.2, 11.4, 11.6,
      11.8, 12.0, 12.2, 12.4, 12.6, 12.8, 13.0,
    ],
  ),
  "4": table(
    "lower_is_better",
    [
      8.7, 8.8, 8.9, 9.0, 9.1, 9.3, 9.5, 9.7, 9.9, 10.1, 10.3, 10.5, 10.7, 10.9,
      11.1, 11.3, 11.5, 11.7, 11.9, 12.1,
    ],
    [
      8.7, 8.8, 8.9, 9.2, 9.5, 9.7, 9.9, 10.1, 10.3, 10.5, 10.7, 10.9, 11.1,
      11.3, 11.5, 11.7, 11.9, 12.1, 12.3, 12.5,
    ],
  ),
  "5": table(
    "lower_is_better",
    [
      8.4, 8.5, 8.6, 8.7, 8.8, 9.0, 9.2, 9.4, 9.6, 9.8, 10.0, 10.2, 10.4, 10.6,
      10.8, 11.0, 11.2, 11.4, 11.6, 11.8,
    ],
    [
      8.3, 8.4, 8.5, 8.8, 9.1, 9.3, 9.5, 9.7, 9.9, 10.1, 10.3, 10.5, 10.7, 10.9,
      11.1, 11.3, 11.5, 11.7, 11.9, 12.1,
    ],
  ),
  "6": table(
    "lower_is_better",
    [
      8.2, 8.3, 8.4, 8.5, 8.6, 8.8, 9.0, 9.2, 9.4, 9.6, 9.8, 10.0, 10.2, 10.4,
      10.6, 10.8, 11.0, 11.2, 11.4, 11.6,
    ],
    [
      8.2, 8.3, 8.4, 8.7, 9.0, 9.2, 9.4, 9.6, 9.8, 10.0, 10.2, 10.4, 10.6, 10.8,
...
const sitReachTables: BandTablesByGrade = {
  "1": table(
    "higher_is_better",
    [
      16.1, 14.6, 13.0, 12.0, 11.0, 9.9, 8.8, 7.7, 6.6, 5.5, 4.4, 3.3, 2.2, 1.1,
      0.0, -0.8, -1.6, -2.4, -3.2, -4.0,
    ],
    [
      18.6, 17.3, 16.0, 14.7, 13.4, 12.3, 11.2, 10.1, 9.0, 7.9, 6.8, 5.7, 4.6,
      3.5, 2.4, 1.6, 0.8, 0.0, -0.8, -1.6,
    ],
  ),
  "2": table(
    "higher_is_better",
    [
      16.2, 14.7, 13.2, 11.9, 10.6, 9.5, 8.4, 7.3, 6.2, 5.1, 4.0, 2.9, 1.8, 0.7,
      -0.4, -1.2, -2.0, -2.8, -3.6, -4.4,
    ],
    [
      18.9, 17.6, 16.3, 14.8, 13.3, 12.2, 11.1, 10.0, 8.9, 7.8, 6.7, 5.6, 4.5,
      3.4, 2.3, 1.5, 0.7, -0.1, -0.9, -1.7,
    ],
  ),
  "3": table(
    "higher_is_better",
    [
      16.3, 14.9, 13.4, 11.8, 10.2, 9.1, 8.0, 6.9, 5.8, 4.7, 3.6, 2.5, 1.4, 0.3,
      -0.8, -1.6, -2.4, -3.2, -4.0, -4.8,
    ],
    [
      19.2, 17.9, 16.6, 14.9, 13.2, 12.1, 11.0, 9.9, 8.8, 7.7, 6.6, 5.5, 4.4,
      3.3, 2.2, 1.4, 0.6, -0.2, -1.0, -1.8,
    ],
  ),
  "4": table(
    "higher_is_better",
    [
      16.4, 15.0, 13.6, 11.7, 9.8, 8.6, 7.4, 6.2, 5.0, 3.8, 2.6, 1.4, 0.2, -1.0,
      -2.2, -3.2, -4.2, -5.2, -6.2, -7.2,
    ],
    [
      19.5, 18.1, 16.9, 15.0, 13.1, 12.0, 10.9, 9.8, 8.7, 7.6, 6.5, 5.4, 4.3,
      3.2, 2.1, 1.3, 0.5, -0.3, -1.1, -1.9,
    ],
  ),
  "5": table(
    "higher_is_better",
    [
      16.5, 15.2, 13.8, 11.6, 9.4, 8.2, 7.0, 5.8, 4.6, 3.4, 2.2, 1.0, -0.2,
      -1.4, -2.6, -3.6, -4.6, -5.6, -6.6, -7.6,
    ],
    [
      19.8, 18.5, 17.2, 15.1, 13.0, 11.9, 10.8, 9.7, 8.6, 7.5, 6.4, 5.3, 4.2,
      3.1, 2.0, 1.2, 0.4, -0.4, -1.2, -2.0,
    ],
  ),
  "6": table(
    "higher_is_better",
    [
      16.6, 15.3, 14.0, 11.5, 9.0, 7.7, 6.4, 5.1, 3.8, 2.5, 1.2, -0.1, -1.4,
      -2.7, -4.0, -5.0, -6.0, -7.0, -8.0, -9.0,
    ],
    [
      19.9, 18.7, 17.5, 15.2, 12.9, 11.8, 10.7, 9.6, 8.5, 7.4, 6.3, 5.2, 4.1,
      3.0, 1.9, 1.1, 0.3, -0.5, -1.3, -2.1,
    ],
  ),
};
...
const rope1minTables: BandTablesByGrade = {
  "1": tableWithBonus(
    "higher_is_better",
    [
      109, 104, 99, 93, 87, 80, 73, 66, 59, 52, 45, 38, 31, 24, 17, 14, 11, 8,
      5, 2,
    ],
    [
      117, 110, 103, 95, 87, 80, 73, 66, 59, 52, 45, 38, 31, 24, 17, 14, 11, 8,
      5, 2,
    ],
    109,
    2,
  ...
  "2": tableWithBonus(
    "higher_is_better",
    [
      117, 112, 107, 101, 95, 88, 81, 74, 67, 60, 53, 46, 39, 32, 25, 22, 19,
      16, 13, 10,
    ],
    [
      127, 120, 113, 105, 97, 90, 83, 76, 69, 62, 55, 48, 41, 34, 27, 24, 21,
      18, 15, 12,
    ],
    117,
    2,
  ...
  "3": tableWithBonus(
    "higher_is_better",
    [
      126, 121, 116, 110, 104, 97, 90, 83, 76, 69, 62, 55, 48, 41, 34, 31, 28,
      25, 22, 19,
    ],
    [
      139, 132, 125, 117, 109, 102, 95, 88, 81, 74, 67, 60, 53, 46, 39, 36, 33,
      30, 27, 24,
    ],
    126,
    2,
  ...
  "4": tableWithBonus(
    "higher_is_better",
    [
      137, 132, 127, 121, 115, 108, 101, 94, 87, 80, 73, 66, 59, 52, 45, 42, 39,
      36, 33, 30,
    ],
    [
      149, 142, 135, 127, 119, 112, 105, 98, 91, 84, 77, 70, 63, 56, 49, 46, 43,
      40, 37, 34,
    ],
    137,
    2,
  ...
  "5": tableWithBonus(
    "higher_is_better",
    [
      148, 143, 138, 132, 126, 119, 112, 105, 98, 91, 84, 77, 70, 63, 56, 53,
      50, 47, 44, 41,
    ],
    [
      158, 151, 144, 136, 128, 121, 114, 107, 100, 93, 86, 79, 72, 65, 58, 55,
      52, 49, 46, 43,
    ],
    148,
    2,
  ...
  "6": tableWithBonus(
    "higher_is_better",
    [
      157, 152, 147, 141, 135, 128, 121, 114, 107, 100, 93, 86, 79, 72, 65, 62,
      59, 56, 53, 50,
    ],
    [
      166, 159, 152, 144, 136, 129, 122, 115, 108, 101, 94, 87, 80, 73, 66, 63,
      60, 57, 54, 51,
    ],
    157,
    2,
...
const lungCapacityTables: BandTablesByGrade = {
  "1": table(
    "higher_is_better",
    [
      1700, 1600, 1500, 1400, 1300, 1240, 1180, 1120, 1060, 1000, 940, 880, 820,
      760, 700, 660, 620, 580, 540, 500,
    ],
    [
      1400, 1300, 1200, 1100, 1000, 960, 920, 880, 840, 800, 760, 720, 680, 640,
  ...
  "2": table(
    "higher_is_better",
    [
      2000, 1900, 1800, 1650, 1500, 1430, 1360, 1290, 1220, 1150, 1080, 1010,
      940, 870, 800, 750, 700, 650, 600, 550,
    ],
    [
      1600, 1500, 1400, 1300, 1200, 1150, 1100, 1050, 1000, 950, 900, 850, 800,
      750, 700, 680, 660, 640, 620, 600,
    ],
  ),
  "3": table(
    "higher_is_better",
    [
      2300, 2200, 2100, 1900, 1700, 1620, 1540, 1460, 1380, 1300, 1220, 1140,
      1060, 980, 900, 840, 780, 720, 660, 600,
    ],
    [
      1800, 1700, 1600, 1500, 1400, 1340, 1280, 1220, 1160, 1100, 1040, 980,
      920, 860, 800, 780, 760, 740, 720, 700,
    ],
  ),
  "4": table(
    "higher_is_better",
    [
      2600, 2500, 2400, 2150, 1900, 1820, 1740, 1660, 1580, 1500, 1420, 1340,
      1260, 1180, 1100, 1030, 960, 890, 820, 750,
    ],
    [
      2000, 1900, 1800, 1700, 1600, 1530, 1460, 1390, 1320, 1250, 1180, 1110,
      1040, 970, 900, 880, 860, 840, 820, 800,
    ],
  ),
  "5": table(
    "higher_is_better",
    [
      2900, 2800, 2700, 2450, 2200, 2110, 2020, 1930, 1840, 1750, 1660, 1570,
      1480, 1390, 1300, 1220, 1140, 1060, 980, 900,
    ],
    [
      2250, 2150, 2050, 1950, 1850, 1770, 1690, 1610, 1530, 1450, 1370, 1290,
      1210, 1130, 1050, 1020, 990, 960, 930, 900,
    ],
  ),
  "6": table(
    "higher_is_better",
    [
      3200, 3100, 3000, 2750, 2500, 2400, 2300, 2200, 2100, 2000, 1900, 1800,
      1700, 1600, 1500, 1410, 1320, 1230, 1140, 1050,
    ],
    [
      2500, 2400, 2300, 2200, 2100, 2010, 1920, 1830, 1740, 1650, 1560, 1470,
      1380, 1290, 1200, 1170, 1140, 1110, 1080, 1050,
    ],
  ),
};
...
const sitUpTables: BandTablesByGrade = {
  "3": table(
    "higher_is_better",
    [
      48, 45, 42, 39, 36, 34, 32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8,
      6,
    ],
    [
      46, 44, 42, 39, 36, 34, 32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8,
      6,
    ],
  ),
  "4": table(
    "higher_is_better",
    [
      49, 46, 43, 40, 37, 35, 33, 31, 29, 27, 25, 23, 21, 19, 17, 15, 13, 11, 9,
      7,
    ],
    [
      47, 45, 43, 40, 37, 35, 33, 31, 29, 27, 25, 23, 21, 19, 17, 15, 13, 11, 9,
      7,
    ],
  ),
  "5": table(
    "higher_is_better",
    [
      50, 47, 44, 41, 38, 36, 34, 32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12,
      10, 8,
    ],
    [
      48, 46, 44, 41, 38, 36, 34, 32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12,
      10, 8,
    ],
  ),
  "6": table(
    "higher_is_better",
    [
      51, 48, 45, 42, 39, 37, 35, 33, 31, 29, 27, 25, 23, 21, 19, 17, 15, 13,
      11, 9,
    ],
    [
      49, 47, 45, 42, 39, 37, 35, 33, 31, 29, 27, 25, 23, 21, 19, 17, 15, 13,
      11, 9,
    ],
  ),
};
...
export const gradeBandFor = (
  grade: number,
): "1" | "2" | "3" | "4" | "5" | "6" => {
  if (grade >= 1 && grade <= 6)
    return String(grade) as "1" | "2" | "3" | "4" | "5" | "6";
  throw new Error(`该标准仅支持小学一至六年级，当前为 ${grade} 年级。`);
};

export const weightsFor = (grade: number): Record<string, number> => {
  if (grade === 1 || grade === 2)
    return {
      bmi: 0.15,
      lung_capacity: 0.15,
...
function scoreFromTable(tableValue: BandTable, value: number): BandScoreResult {
  ...
  if (!matched)
    return { score: 0, bonus: 0, matched: null, band_label: "未达到最低分档" };
  let bonus = 0;
...
export function scoreNational2014(input: ScoreInput): EngineResult {
  ...
  const valueByCode = new Map(
    values.map((item) => [item.indicator_code, item]),
  );
  ...
  const results: EngineIndicatorScore[] = indicatorCodes.map((code) => {
    ...
    const tableValue =
      lookupBandTable(code, grade)?.[sexKey(child.sex_code)] ?? null;
    if (!tableValue) {
      return {
        indicator_code: code,
        score: null,
  ...
  const standardScore = Number(
    results.reduce((sum, item) => sum + item.contribution, 0).toFixed(1),
  );

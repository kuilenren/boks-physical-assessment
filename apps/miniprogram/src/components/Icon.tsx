...
type IconTone = "brand" | "forest" | "sky" | "amber" | "ink" | "white" | "danger";
...
const PATHS: Record<IconName, string> = {
  ...
  posture:
    "M12 4.5a2 2 0 1 1 0 4 2 2 0 0 1 0-4zM10 10h4l1.5 4.5L18 20h-2.2l-1.6-4h-2.4L10.2 20H8l2.5-5.5L10 10zm-1 4.2-2.2 1.3.9 1.5 2.1-1.2m6 0 2.2 1.3-.9 1.5-2.1-1.2",
  training:
...
function toSrc(name: IconName, color: string) {
...
export function IconBadge({
  ...
  return (
    <View
      ...
      style={{ width: `${size}px`, height: `${size}px` }}
    >
      <Icon name={name} tone={tone === "white" ? "white" : tone} size={Math.round(size * 0.48)} />
    </View>
  );
}
